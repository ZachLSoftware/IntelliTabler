# Generated by Django 4.1.3 on 2023-01-11 17:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='timetable.teacher')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='timetable.modulegroup')),
            ],
        ),
        migrations.CreateModel(
            name='Availability',
