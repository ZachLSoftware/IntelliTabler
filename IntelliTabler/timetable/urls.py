...
urlpatterns = [
    ...
    path('calendar/<int:timetableId>/<int:teacher>', dataViews.calendarView, name="calendarView"),
    ...
    path('getCalendar/<int:timetableId>/<int:teacher>', dataViews.getCalendar, name="getCalendar"),
