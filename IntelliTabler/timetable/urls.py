...
urlpatterns = [
    ...
    path('teacherPreferences/<int:teacherId>/<int:timetableId>', dataViews.teacherPreferences, name='teacherPreferences'),
    path('preferences/<int:timetableId>', dataViews.preferences, name='preferences'),
    path('addPreferences/<int:timetableId>/<int:teacherId>', formViews.addPreference, name='addPreference'),
